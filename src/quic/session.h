...
class Session final : public AsyncWrap, private SessionTicket::AppData::Source {
 ...
 private:
  ...
  // clients or from the ClientHello callback for servers (later in the
  // handshake, after session-ticket decryption). Must be called before
  // any application data is received.
