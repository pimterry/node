...
class Http3Session {
   ...
   */
  get settings() {
    const handle = this.#session[kSessionHandle];
    return handle === undefined ? null : handle.applicationOptions();
  }
   ...
   */
  get onstream() { return this.#session.onstream; }
  set onstream(fn) { this.#session.onstream = fn; }
