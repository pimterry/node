...
class QuicSessionState {
  ...
  /** @type {boolean} */
  get hasSettingsListener() {
    return this.#getListenerFlag(QuicSessionState.#LISTENER_SETTINGS);
  }
  set hasSettingsListener(val) {
    this.#setListenerFlag(QuicSessionState.#LISTENER_SETTINGS, val);
  }
