...
class QuicSessionState {
  ...
  /**
   * The type of application installed on the session: 0 when none has
   * been selected yet (the dynamic-attachment window is still open),
   * 1 for the DefaultApplication, 2 for HTTP/3.
   * @type {number}
   */
  get applicationType() {
    const handle = this.#handle;
