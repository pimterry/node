...
// application processing (here, the Http3Session has no onstream handler)
// is reset with H3_REQUEST_REJECTED (0x10b) so the peer learns the request
...
const clientSession = await connectHttp3(serverEndpoint.address, {
